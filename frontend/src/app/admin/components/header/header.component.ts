...
@Component({
  ...
  template: `
    <header class="admin-header">
      ...
      <nav class="header-nav">
        ...
        <a routerLink="/admin/messages" routerLinkActive="active" class="nav-link">
  ...
  `,
   styles: [`
     ...
     .nav-link { display: flex; align-items: center; gap: 8px; padding: 8px 16px; border-radius: var(--radius-md); color: var(--on-surface); text-decoration: none; font-size: 14px; font-weight: 500; opacity: 0.7; position: relative; }
     ...
     .unread-badge { position: absolute; top: 4px; right: 4px; min-width: 18px; height: 18px; padding: 0 5px; background: var(--error); color: var(--on-error); font-size: 11px; font-weight: 700; border-radius: 9px; display: flex; align-items: center; justify-content: center; }
